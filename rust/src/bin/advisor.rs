...
use chrono::Utc;
use mini_hack_session4::modelprovider::{new_model_client, Message};
use mini_hack_session4::normalize::{normalize_many, RawTx};
...
async fn get_wallet_history(wallet_address: &str) -> Result<Vec<mini_hack_session4::normalize::Tx>, Box<dyn std::error::Error>> {
...
fn build_summary_prompt(txs: &[mini_hack_session4::normalize::Tx]) -> String {
